...
# -- Workdir path -- 
workdir = '/work/oda/med_dev/Venezia_Acqua_Alta_2019/VAA_wind_ts_new_2022//'
...
# ---  Input archive ---
input_dir          = '/work/oda/med_dev/Venezia_Acqua_Alta_2019/VAA_wind_ts_new_2022//'
#
input_tg   = ['ISMAR_TG']
input_dat  = ['mod_wind','obs_wind_false'] # Do not change the order because the obs are used as reference for offset and differences!
