...
# -- Workdir path -- 
workdir = '/work/oda/med_dev/VAA_w08_w10_ANFC_plot_wind/'
...
# ---  Input archive ---
input_dir          = '/work/oda/med_dev/VAA_w08_w10_ANFC_wind/'
#
input_tg   = ['ISMAR_TG']
...
#                                 print ('No')
    ...
    plt.title('ECMWF W10M Speed time-series '+tg,fontsize=18)
    if time_p == 'allp' :
